...
def is_duplicated_number(three_digit):
    ...
    result = True if len(set(three_digit)) != len(three_digit) else False
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    result = True if one_more_input.lower() in ['no', 'n'] else False
    # ==================================
    return result
...
def main():
    ...
    while True:
        ...
        if strikes == 3:
            ...
            while not is_yes(more) and not is_no(more):
                print('Wrong Input, Input again')
                more = input('You win, one more (Y/N)')
            if is_yes(more):
                random_number = str(get_not_duplicated_three_digit_number())
